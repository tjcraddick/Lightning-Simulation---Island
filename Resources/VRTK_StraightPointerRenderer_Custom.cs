...
namespace VRTK
{
    ...
    /// </example>
    public class VRTK_StraightPointerRenderer_Custom : VRTK_BasePointerRenderer
    {
        ...
        public override void UpdateRenderer()
        {
            if ((controllingPointer && controllingPointer.IsPointerActive()) || IsVisible())
            {
                ...
                //Debug.Log("Cursor: " + actualCursor.transform.position);
            }
            base.UpdateRenderer();
        }

        public Vector3 returnCursorPos()
        {
            return actualCursor.transform.position;
        }
